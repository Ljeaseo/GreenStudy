...
<div class="container">
	...
	<div class="detail_box">
		<div class="detail_box_img">
			<img src="${pageContext.request.contextPath}/resources/img/FG5.jpg">
		</div>
		<div class="detail_box_content">
			<h3><span style="color:red;">F</span>S5</h3><input type="hidden" id="gi_name" value="FS5">
			<h5>$2,216</h5><input type="hidden" id="gi_price" value=2216>
		...
		<div class="detail_more_img">
			<img id="img_1" src="${pageContext.request.contextPath}/resources/img/yamaha-FS5_1.jpg">
			<img src="${pageContext.request.contextPath}/resources/img/yamaha-FS5_2.jpg">
			<img src="${pageContext.request.contextPath}/resources/img/yamaha-FS5_9.jpg">
			<img src="${pageContext.request.contextPath}/resources/img/yamaha-FS5_10.jpg">
			<img src="${pageContext.request.contextPath}/resources/img/yamaha-FS5_11.jpg">
			<img src="${pageContext.request.contextPath}/resources/img/yamaha-FS5_12.jpg">
			<img src="${pageContext.request.contextPath}/resources/img/yamaha-FS5_13.jpg">
			<img src="${pageContext.request.contextPath}/resources/img/yamaha-FS5_15.jpg">
			<img src="${pageContext.request.contextPath}/resources/img/yamaha-FS5_16.jpg">
			<img src="${pageContext.request.contextPath}/resources/img/yamaha-FS5_17.jpg">
		...
		<tr>
				<td colspan = 5 style='letter-spacing:10px' id="page">
					<c:if test="${paging.prev}">
						<a href="/FG5?guitar_no=7&type=${paging.cri.type}&pageNum=${paging.startPage-1}&amount=${paging.cri.amount}" style="color:black;">이전</a>
					</c:if>

					<c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="num">
 						<a href="/FG5?guitar_no=7&type=${paging.cri.type}&pageNum=${num}&amount=${paging.cri.amount}" style="color:black;">${num}</a>
					</c:forEach>
					
					<c:if test="${paging.next}">
						<a href="/FG5?guitar_no=7&type=${paging.cri.type}&pageNum=${paging.endPage+1}&amount=${paging.cri.amount}" style="color:black;">다음</a>
					</c:if>
				</td>
			</tr>
	</tbody>	
			...
			<tr>
				<td colspan = 5 style='letter-spacing:10px' id="qnapage">
					<c:if test="${qnapaging.qprev}">
						<a href="/FG5?guitar_no=7&qtype=${qnapaging.qcri.qtype}&qpageNum=${qnapaging.qstartPage-1}&qamount=${qnapaging.qcri.qamount}" style="color:black;">이전</a>
					</c:if>

					<c:forEach begin="${qnapaging.qstartPage}" end="${qnapaging.qendPage}" var="num">
 						<a href="/FG5?guitar_no=7&qtype=${qnapaging.qcri.qtype}&qpageNum=${num}&qamount=${qnapaging.qcri.qamount}" style="color:black;">${num}</a>
					</c:forEach>
					
					<c:if test="${qnapaging.qnext}">
						<a href="/FG5?guitar_no=7&qtype=${qnapaging.qcri.qtype}&qpageNum=${qnapaging.qendPage+1}&qamount=${qnapaging.qcri.qamount}" style="color:black;">다음</a>
					</c:if>
				</td>
			</tr>	
		</tbody>	
