...
<div class="container">
	...
	<div class="detail_box">
		...
		<div class="detail_box_content">
			<h3>F<span style="color:red;">G</span>X3</h3><input type="hidden" id="gi_name" value="FGX3">
			<h5>$1,664</h5><input type="hidden" id="gi_price" value=1664>
		...
		<div class="detail_more_img">
			<img id="img_1" src="${pageContext.request.contextPath}/resources/img/yamaha-FGX3_1.jpg">
			<img src="${pageContext.request.contextPath}/resources/img/yamaha-FGX3_2.jpg">
			<img src="${pageContext.request.contextPath}/resources/img/yamaha-FGX3_9.jpg">
			<img src="${pageContext.request.contextPath}/resources/img/yamaha-FGX3_10.jpg">
			<img src="${pageContext.request.contextPath}/resources/img/yamaha-FGX3_11.jpg">
			<img src="${pageContext.request.contextPath}/resources/img/yamaha-FGX3_12.jpg">
			<img src="${pageContext.request.contextPath}/resources/img/yamaha-FGX3_13.jpg">
			<img src="${pageContext.request.contextPath}/resources/img/yamaha-FGX3_15.jpg">
			<img src="${pageContext.request.contextPath}/resources/img/yamaha-FGX3_14.jpg">
		...
		<tr>
				<td colspan = 5 style='letter-spacing:10px' id="page">
					<c:if test="${paging.prev}">
						<a href="/FGX3?guitar_no=2&type=${paging.cri.type}&pageNum=${paging.startPage-1}&amount=${paging.cri.amount}" style="color:black;">이전</a>
					</c:if>

					<c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="num">
 						<a href="/FGX3?guitar_no=2&type=${paging.cri.type}&pageNum=${num}&amount=${paging.cri.amount}" style="color:black;">${num}</a>
					</c:forEach>
					
					<c:if test="${paging.next}">
						<a href="/FGX3?guitar_no=2&type=${paging.cri.type}&pageNum=${paging.endPage+1}&amount=${paging.cri.amount}" style="color:black;">다음</a>
					</c:if>
				</td>
			</tr>
	</tbody>	
			...
			<tr>
				<td colspan = 5 style='letter-spacing:10px' id="qnapage">
					<c:if test="${qnapaging.qprev}">
						<a href="/FGX3?guitar_no=2&qtype=${qnapaging.qcri.qtype}&qpageNum=${qnapaging.qstartPage-1}&qamount=${qnapaging.qcri.qamount}" style="color:black;">이전</a>
					</c:if>

					<c:forEach begin="${qnapaging.qstartPage}" end="${qnapaging.qendPage}" var="num">
 						<a href="/FGX3?guitar_no=2&qtype=${qnapaging.qcri.qtype}&qpageNum=${num}&qamount=${qnapaging.qcri.qamount}" style="color:black;">${num}</a>
					</c:forEach>
					
					<c:if test="${qnapaging.qnext}">
						<a href="/FGX3?guitar_no=2&qtype=${qnapaging.qcri.qtype}&qpageNum=${qnapaging.qendPage+1}&qamount=${qnapaging.qcri.qamount}" style="color:black;">다음</a>
					</c:if>
				</td>
			</tr>	
		</tbody>	
